...
for epoch = 1:num_epochs
    ...
    if phase == 1 || phase == 3
        ...
        if phase == 3
            roi_labels = [roi_labels; 0]; % Blink
        else
            roi_labels = [roi_labels; 1]; % No Noise/No Blink
        end
    end
end
...
for epoch = 1:num_interesting_epochs
    ...
    kurtosis_features = kurtosis(epoch_data)-3;
...
new_filtered_EEG = filtfilt(bn, an, new_filtered_EEG);
